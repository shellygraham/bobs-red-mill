...
var $playButton = $("#play");
var $pauseButton = $("#pause-container");
var $muteButton = $("#mute");
...
$playContainer.click(function() {
	playVideo();
 	$playContainer.removeClass("active");
});

// Adds CTA buttons on top of the video after it ends
...
function playVideo() {      
	if($video[0].paused) {
		...
		$pauseButton.removeClass("pause-on");
// 		$buttonControls.hide();
// 		$videoControls.css("margin-top", "5%");	     	
	} else {
		$video[0].pause();
		$playButton.addClass("pause");
		$pauseButton.addClass("pause-on");
	}		
}
